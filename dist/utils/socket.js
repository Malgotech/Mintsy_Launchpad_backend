...
exports.emitLiveStreamChatMessage =
  exports.updateAllUsersLastActive =
  exports.getActiveUserIds =
  exports.getActiveUsersCount =
  exports.getIO =
  exports.emitChartUpdateOnPriceChange =
  exports.emitChartUpdateOnMarketChange =
  exports.emitChartUpdateForCoin =
  exports.emitChartUpdate =
  exports.initSocket =
    void 0;
// src/socket.ts
...
async function getChartData(coinId, timeframe, interval) {
  try {
    ...
    if (trades.length === 0) {
      const { createBaselineCandle } = await Promise.resolve().then(() =>
