  ...
  constructor() {
    ...
    this.getTokenList = async (req, res) => {
      try {
        ...
        // graduationStatus filter
        if (status) {
          whereClause.graduationStatus = status;
        }
    ...
    //     const activeTradersCount = await prisma.trade
    //       .groupBy({
    //         by: ["userId"],
    //         where: {
    //           createdAt: {
    ...
    //     const previousActiveTradersCount = await prisma.trade
    //       .groupBy({
    //         by: ["userId"],
    //         where: {
    //           createdAt: {
    ...
    //     };
    //     const launchedPercentageChange = calculatePercentageChange(
    //       launchedCount,
    //       previousLaunchedCount
    //     );
    //     const graduatedPercentageChange = calculatePercentageChange(
    //       graduatedCount,
    //       previousGraduatedCount
    //     );
    //     const bondedPercentageChange = calculatePercentageChange(
    //       bondedCount,
    //       previousBondedCount
    //     );
    //     const dailyVolumePercentageChange = calculatePercentageChange(
    //       dailyVolume,
    //       previousDailyVolume
    //     );
    //     const activeTradersPercentageChange = calculatePercentageChange(
    //       activeTradersCount,
    //       previousActiveTradersCount
    //     );
        ...
        return res.json({
          ...
          data: {
            ...
            activeTraders: {
              ...
              trend:
                activeTradersCount >= prevActiveTradersCount ? "up" : "down",
              description: "Unique traders in period",
            },
            liquidity: {
              amount: Math.round(liquidity),
